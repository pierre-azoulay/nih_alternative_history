...
putdocx text (" The denominator consists of the 557 drugs approved by the FDA between 2000 and 2023. The patents taken into account were extracted from the FDA Orange Book; patents granted after the approval year were excluded from the analysis. Using priority scores randomly drawn from the empirical distribution of actual scores, there are 279 (50.1%) drug approvals that do not cite any at-risk NIH research. Of this set, 94 (16.9%) are associated with patents that do not reference any scientific publications; a further 132 (23.7%) have patents that do reference scientific publications, but none of these publications acknowledge NIH grant support; finally, 53 approvals (9.5%) have patents that do reference scientific publications that acknowledge NIH grant support, but none of these grants would disappear under our hypothetical 40% cut. Some of these numbers differ slightly from those reported in the published version of the article (since they reflect prioritization using random-yet-realistic scores rather than actual awarded scores).") ;
